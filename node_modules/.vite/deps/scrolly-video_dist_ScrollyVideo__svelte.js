...
var require_mp4box_all = __commonJS({
  "node_modules/mp4box/dist/mp4box.all.js"(exports) {
    ...
    BoxParser.av01SampleEntry.prototype.getCodec = function() {
      ...
      return baseCodec + "." + this.av1C.seq_profile + "." + this.av1C.seq_level_idx_0 + (this.av1C.seq_tier_0 ? "H" : "M") + "." + bitdepth;
    };
    ...
    ISOFile.prototype.flattenItemInfo = function() {
      ...
      if (meta.iref) {
        for (i = 0; i < meta.iref.references.length; i++) {
          var ref2 = meta.iref.references[i];
    ...
    ISOFile.prototype.itemToFragmentedTrackFile = function(_options) {
      ...
      if (item == null)
        return null;
      var file2 = new ISOFile();
      file2.discardMdatData = false;
      var trackOptions = { type: item.type, description_boxes: item.properties.boxes };
      if (item.properties.ispe) {
        trackOptions.width = item.properties.ispe.image_width;
        trackOptions.height = item.properties.ispe.image_height;
      }
      var trackId = file2.addTrack(trackOptions);
      if (trackId) {
        file2.addSample(trackId, item.data);
        return file2;
      } else {
        return null;
      }
    ...
    MP4Box2.createFile = function(_keepMdatData, _stream) {
      ...
      var file2 = new ISOFile(_stream);
      file2.discardMdatData = keepMdatData ? false : true;
      return file2;
    };
    if (typeof exports !== "undefined") {
...
// node_modules/scrolly-video/dist/ScrollyVideo.js
var import_ua_parser_js = __toESM(require_ua_parser());

// node_modules/scrolly-video/dist/videoDecoder.js
var MP4Box = __toESM(require_mp4box_all());
var Writer = class {
  constructor(size) {
...
var decodeVideo = (src, emitFrame, { VideoDecoder: VideoDecoder2, EncodedVideoChunk: EncodedVideoChunk2, debug }) => new Promise((resolve, reject) => {
  if (debug)
  ...
  try {
    ...
    mp4boxfile.onSamples = (track_id, ref2, samples) => {
...
var videoDecoder_default = (src, emitFrame, debug) => {
...
// node_modules/scrolly-video/dist/utils.js
...
var isScrollPositionAtTarget = (targetScrollPosition, threshold = 1) => {
...
// node_modules/scrolly-video/dist/ScrollyVideo.js
var ScrollyVideo = class {
  constructor({
    src,
    // The src of the video, required
    scrollyVideoContainer,
    // The dom element or id that this object will be created in, required
    cover = true,
    ...
    // A callback that invokes on video decode
    onChange = () => {
    },
    // A callback that invokes on video percentage change
    debug = false
    ...
    const browserEngine = new import_ua_parser_js.default().getEngine();
    ...
    this.updateScrollPercentage = (jump) => {
      ...
      const scrollPercent = -containerBoundingClientRect.top / // eslint-disable-next-line no-undef
    ...
    this.resize = () => {
      if (this.debug)
        console.info("ScrollyVideo resizing...");
      if (this.cover)
  ...
  transitionToTargetTime({
    ...
    const tick = ({ startCurrentTime, startTimestamp, timestamp }) => {
      ...
      const hasPassedThreshold = isForwardTransition ? this.currentTime >= this.targetTime : this.currentTime <= this.targetTime;
      if (
        // eslint-disable-next-line no-restricted-globals
        isNaN(this.targetTime) || // If the currentTime is already close enough to the targetTime
        Math.abs(this.targetTime - this.currentTime) < this.frameThreshold || hasPassedThreshold
      ) {
        this.video.pause();
        if (this.transitioningRaf) {
      ...
      const easedProgress = easing && Number.isFinite(progress) ? easing(progress) : null;
      const easedCurrentTime = isForwardTransition ? startCurrentTime + easedProgress * Math.abs(distance) * transitionSpeed : startCurrentTime - easedProgress * Math.abs(distance) * transitionSpeed;
      if (this.canvas) {
        if (jump) {
      ...
      if (typeof requestAnimationFrame === "function") {
        this.transitioningRaf = requestAnimationFrame(
  ...
  setTargetTimePercent(percentage, options = {}) {
    const targetDuration = this.frames.length && this.frameRate ? this.frames.length / this.frameRate : this.video.duration;
  ...
  destroy() {
    if (this.debug)
      console.info("Destroying ScrollyVideo");
    if (this.trackScroll)
...
var ScrollyVideo_default = ScrollyVideo;

// node_modules/scrolly-video/dist/ScrollyVideo.svelte
var file = "node_modules/scrolly-video/dist/ScrollyVideo.svelte";
function create_fragment(ctx) {
  let div;
  const block = {
    c: function create() {
      div = element("div");
      attr_dev(div, "data-scrolly-container", "");
      add_location(div, file, 50, 0, 1444);
    },
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("ScrollyVideo", slots, []);
  let scrollyVideoContainer;
  let scrollyVideo;
  let lastPropsString = "";
  function setVideoPercentage(...args) {
  ...
  function div_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      scrollyVideoContainer = $$value;
      $$invalidate(0, scrollyVideoContainer);
    });
  }
  $$self.$$set = ($$new_props) => {
  ...
  $$self.$capture_state = () => ({
    onDestroy,
    ScrollyVideo: ScrollyVideo_default,
    scrollyVideoContainer,
    scrollyVideo,
    lastPropsString,
    setVideoPercentage
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("scrollyVideoContainer" in $$props)
      $$invalidate(0, scrollyVideoContainer = $$new_props.scrollyVideoContainer);
    if ("scrollyVideo" in $$props)
      $$invalidate(2, scrollyVideo = $$new_props.scrollyVideo);
    if ("lastPropsString" in $$props)
      $$invalidate(3, lastPropsString = $$new_props.lastPropsString);
  };
    ...
    $: {
      if (scrollyVideoContainer) {
        ...
        if (JSON.stringify(restProps) !== lastPropsString) {
          if (scrollyVideo && scrollyVideo.destroy)
            scrollyVideo.destroy();
          $$invalidate(2, scrollyVideo = new ScrollyVideo_default({ ...restProps, scrollyVideoContainer }));
          $$invalidate(3, lastPropsString = JSON.stringify(restProps));
        }
...
var ScrollyVideo_1 = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance, create_fragment, safe_not_equal, { setVideoPercentage: 1 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "ScrollyVideo_1",
      options,
      id: create_fragment.name
    });
  }
  get setVideoPercentage() {
    return this.$$.ctx[1];
  }
  set setVideoPercentage(value) {
    throw new Error("<ScrollyVideo>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
};
var ScrollyVideo_default2 = ScrollyVideo_1;
export {
  ScrollyVideo_default2 as default
};
//# sourceMappingURL=scrolly-video_dist_ScrollyVideo__svelte.js.map
